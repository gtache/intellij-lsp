...
import org.jetbrains.plugins.scala.lang.psi.{PresentationUtil, ScalaPsiElement, ScalaPsiUtil, StructureViewUtil}
...
class ScalaDocumentationProvider extends CodeDocumentationProvider {
  ...
  def generateDoc(element: PsiElement, originalElement: PsiElement): String = {
    ...
    implicit def urlText: ScType => String = new DottyTypeSystem().urlText(_)
