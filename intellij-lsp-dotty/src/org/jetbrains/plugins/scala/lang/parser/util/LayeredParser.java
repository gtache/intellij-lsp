...
//      validNumbersLookUp = new TreeMap<Integer, Integer>();
    ...
    void copyMarkersWithRoot(IElementType rootElementType) {
      final Marker rootMarker = rootElementType != null ? myDelegate.mark() : null;
...
//          }
    ...
    private abstract class FakeMarker implements Marker {
  ...
  public interface CustomTokenChooser {
     ...
     * {@link CustomTokenChooser#shouldSelectForeignToken(IElementType)}
     */
