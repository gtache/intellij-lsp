...
import org.jetbrains.plugins.scala.lang.psi.{ScDeclarationSequenceHolder, ScImportsHolder, ScalaPsiUtil, ScalaStubBasedElementImpl}
import org.jetbrains.plugins.scala.lang.psi.api.ScPackageLike
import org.jetbrains.plugins.scala.lang.psi.api.base.ScStableCodeReferenceElement
import org.jetbrains.plugins.scala.lang.psi.api.toplevel.ScPackaging
import org.jetbrains.plugins.scala.lang.psi.api.toplevel.typedef.ScTypeDefinition
import org.jetbrains.plugins.scala.lang.psi.impl.{ScPackageImpl, ScalaFileImpl}
...
class ScPackagingImpl private(stub: ScPackagingStub, node: ASTNode)
  ...
  override def processDeclarations(processor: PsiScopeProcessor,
    ...
    if (getStub != null || !reference.exists(c => c==lastParent)) {
