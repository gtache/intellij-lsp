 ...
 */
public final class ArtifactSettingsGUI implements LSPGUI {
    private static final Logger logger = Logger.getInstance(ArtifactSettingsGUI.class);
    ...
    private final LSPPersistentApplicationSettings settings;

    public ArtifactSettingsGUI() {
        settings = ApplicationManager.getApplication().getService(LSPPersistentApplicationSettings.class);
