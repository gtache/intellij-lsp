...
data class LSPPsiReference(private var element: PsiElement) : PsiReference {
     ...
     *
     * Returns the underlying element of the reference.
     */
     ...
     *
     * Returns Relative range in element
     */
     ...
     *
     * Returns the target element, or null if it was not possible to resolve the reference to a valid target.
     ...
     * a Java class).
     *
     * Returns the canonical text of the reference.
     */
     ...
     * Returns true if the reference targets that element, false otherwise.
     */
     ...
     *
     * Returns the array of available identifiers.
     */
     ...
     *
     * Returns true if the reference is soft, false otherwise.
     */
