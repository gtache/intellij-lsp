package com.github.gtache.lsp.settings.application.gui
 ...
 */
class TimeoutSettingsGUI : LSPGUI {
    ...
    override fun apply() {
        ...
        val appSettings = service<LSPPersistentApplicationSettings>()
